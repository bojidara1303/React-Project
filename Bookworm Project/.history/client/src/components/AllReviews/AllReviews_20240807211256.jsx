...
export default function AllReviews() {
    ...
    const onDeleteReviewHandler = async (review) => {
        ...
        if (isConfirmed) {
            await deleteQuote(review._id);
            setQuotes(reviews => reviews.filter((el) => el._id !== review._id));
        }
    }
                        ...
                        <div className={styles["container"]}>
                            ...
                            {userId === _ownerId &&
                                <div className={styles["btn-container"]}>
                                    ...
                                    <p className={styles["trash-icon"]}><i className="fa-solid fa-trash" onClick={() => onDeleteReviewHandler()}></i></p>
                                </div>
                            }
                        </div>
