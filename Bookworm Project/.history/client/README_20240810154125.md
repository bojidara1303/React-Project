...
The unauthorised users have access to the Books section and the Quotes section, where can see quotes, books and reviews which have already been added, but are not allowed to add new quotes, books and reviews for them.

The authorised users have access to all sections and functions of the application. 
